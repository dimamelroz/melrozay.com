              ...
              <div style={{ flex: 1, display: "flex", flexDirection: "column", maxWidth: 600 }}>
                ...
                <div className="about-copy">
                  <p>
                    ...
                    креативный продюсер. уже 7 лет помогаю брендам, артистам и
                    командам находить <strong>точную форму для рекламы, клипов,
                    шоу и бренд-контента</strong>. базируюсь в Москве, но
                    работаю по всей России.
                  </p>
                  <p>
                    соединяю <strong>визуальную эстетику</strong> с точной{" "}
                    <strong>формой, ритмом и интонацией</strong> проекта – чтобы
                    видео работало на идею и зрительское вовлечение.
                  </p>
                  <p>
